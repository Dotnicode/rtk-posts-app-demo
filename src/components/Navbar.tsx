...
import { fetchNotifications, selectUnreadNotificationsCount } from '@/features/notifications/notification.slice'
...
export const Navbar = () => {
  ...
  if (isLoggedIn) {
    ...
    let numUnreadNotificationsBadge: React.ReactNode | undefined
